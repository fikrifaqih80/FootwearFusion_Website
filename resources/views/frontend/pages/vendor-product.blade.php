                                    ...
                                    <div class="col-xl-3 col-sm-6">
                                        <div class="wsus__product_item">
                                            ...
                                            <div class="wsus__product_details">
                                                ...
                                                @if(checkDiscount($product))
                                                    <p class="wsus__price">{{$settings->currency_symbol}}{{$product->offer_price}} <del>{{$settings->currency_symbol}}{{$product->price}}</del></p>
                                                @else
                                                    <p class="wsus__price">{{$settings->currency_symbol}}{{$product->price}}</p>
                                                @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="wsus__pro_details_text">
                                    ...
                                    @if (checkDiscount($product))
                                        <h4>{{$settings->currency_symbol}}{{$product->offer_price}} <del>{{$settings->currency_symbol}}{{$product->price}}</del></h4>
                                    @else
                                        <h4>{{$settings->currency_symbol}}{{$product->price}}</h4>
                                    @endif
                                    <p class="review">
                                        @php
                                        $avgRating = $product->reviews()->avg('rating');
...
@push('scripts')
    <script>
        ...
        jQuery("#slider_range").flatslider({
            ...
            values: [{{$from}}, {{$to}}],
            range: true,
            einheit: '{{$settings->currency_symbol}}'
        });
    });
    </script>
@endpush
