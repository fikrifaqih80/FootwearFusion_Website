...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request)
    {
        ...
        if ($product->qty === 0) {
            ...
            return response()->json(['status' => 'error', 'message' => 'Quantity not available in our stock']);
        }
    ...
    public function updateProductQty(Request $request)
    {
        ...
        return response()->json(['status' => 'success', 'message' => 'Product Quantity Updated!', 'product_total' => $productTotal]);
    }
    ...
    public function applyCoupon(Request $request)
    {
        ...
        if ($coupon === null) {
            return response()->json(['status' => 'error', 'message' => 'Coupon not exist!']);
