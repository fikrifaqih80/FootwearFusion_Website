    ...
    $(document).ready(function() {
                    ...
                    for (let item in data) {
                        ...
                        <li id="mini_cart_${product.rowId}">
                            ...
                            <div class="wsus__cart_text">
                                ...
                                <p>{{ $settings->currency_symbol }}${product.price}</p>
                                <small>Variants total: {{ $settings->currency_symbol }}${product.options.variants_total}</small>
                                <br>
        ...
        function getSidebarCartSubtoal() {
            $.ajax({
                ...
                success: function(data) {
                    $('#mini_cart_subtotal').text("{{ $settings->currency_symbol }}" + data);
                },
                error: function(data) {
